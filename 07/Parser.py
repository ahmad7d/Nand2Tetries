...
class Parser:
    ...
    def command_type(self) -> str:
        ...
        if self.current_command in ["add", "sub", "neg", "eq", "and", "or", "not", "shiftleft", "shiftright", "gt", "lt"]:
            return "C_ARITHMETIC"
    ...
    def arg2(self) -> int:
        ...
        if self.command_type() in self.int_commands:
            number_as_string = ''.join([char for char in self.current_command if char.isdigit()])
